...
public class LogEntry
{
    ...
    public LogEntry(int id, String tool, IHttpRequestResponsePersisted requestResponse, URL url, String parameter, String value, String data_md5, int times, Integer response_code,String finger_scan_result, String vuln_scan_result)
    {
        this.id = id;
        this.tool = tool;
